...
public class FileInspector // class FileInspector
{
    ...
    public static void main(String[] args) // start main()
    {
        ...
        File selectedFile; // store File in selectedFile
...
//        String birthYear = "0"; // store year of birth
        ...
        try // do this unless there is an exception
        {
            ...
            if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) // if user chooses a valid file
            {
                ...
                InputStream in = new BufferedInputStream(Files.newInputStream(file, CREATE)); // store Input Stream in in
